...
- `./dot update` pulls latest changes, updates OS packages, re-stows, updates Neovim Lazy/Mason/Tree-sitter state, and runs `pi update --self` plus `pi update --extensions`
